const autosize = {
    ...
    init (textarea) {
        ...
        const height = parseFloat(null);
        // TODO: 请获取textarea的padding-top和padding-bottom值，并分别替换下面的null值
        let ptop=textarea.paddingTop;
        let pbo=textarea.paddingBottom;
        const padding = parseFloat(ptop) + parseFloat(pbo);
